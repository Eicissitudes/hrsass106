...
<script>
import { getPermissionList, delPermission, updatePermission, getPermissionDetail, addPermission } from '@/api/permission'
...
export default {
  ...
  methods: {
    async getPermissionList() {
      // 将数据转化成带children的树形结构
      this.list = await tranListToTreeDate(await getPermissionList(), '0')
    },
    delPermission(id) {
